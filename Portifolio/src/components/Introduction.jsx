...
const Introduction = () => {
    return (
        <section id="Introduction">
            ...
            Nos últimos tempos, tenho focado em inteligência artificial, como reconhecimento facial e de voz para análise de emoções, áreas com grande potencial para aplicações em entrevistas e monitoramento de comportamento.
            Estou sempre em busca de novas tecnologias e melhores práticas para contribuir efetivamente em um ambiente desafiador.
            </p>
